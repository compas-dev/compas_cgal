...
![Straight Skeleton with Holes](../assets/images/example_straight_skeleton_2_interior_straight_skeleton_with_holes.png)

```python
---8<--- "docs/examples/example_straight_skeleton_2_interior_straight_skeleton_with_holes.py"
```
